...
public:
	...
	virtual std::shared_ptr<Lisp_List> type_of() const { return std::make_shared<Lisp_List>(); }
...
public:
	...
	std::shared_ptr<Lisp_List> type_of() const override;
...
public:
	...
	std::shared_ptr<Lisp_Obj> defx(const std::shared_ptr<Lisp_List> &args);
